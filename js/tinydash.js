...
(function() {
  ...
  TD.button = function(opts) {
    ...
    var el = setup("button",opts,toElement('<div class="td td_btn" id="'+opts.id+'" pressed="'+pressed+'"><span>'+opts.label+'</span><div class="td_btn_a">'+opts.glyph+'</div></div>'));
  ...
  TD.toggle = function(opts) {
    var pressed = opts.value?1:0;
    var el = setup("toggle",opts,toElement('<div class="td td_toggle" id="'+opts.id+'" pressed="'+pressed+'"><span>'+opts.label+'</span><div class="td_toggle_a"><div class="td_toggle_b"/></div></div>'));
    el.toggle = true;
    ...
    el.setLabel = function(l) {
      el.setAttribute("innerHTML", l);
      console.log(l);
    };
    return el;
  };
